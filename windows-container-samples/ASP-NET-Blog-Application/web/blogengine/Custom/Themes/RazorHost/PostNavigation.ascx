...
<script runat="server">
    ...
    {
        string vPath = string.Format("~/Custom/Themes/{0}/PostNavigation.cshtml", BlogSettings.Instance.Theme);
        string parsedRazor = RazorHelpers.ParseRazor(vPath, this);  // 'this' is PostNavigationBase.
