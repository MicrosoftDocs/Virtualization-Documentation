...
INSERT INTO be_Posts (BlogID, PostID, Title, Description, PostContent, DateCreated, DateModified, Author, IsPublished)
	...
	'Welcome to BlogEngine.NET 2.6 using MySQL', 
	...
	'<p>If you see this post it means that BlogEngine.NET 2.6 is running and the hard part of creating your own blog is done. There is only a few things left to do.</p>
