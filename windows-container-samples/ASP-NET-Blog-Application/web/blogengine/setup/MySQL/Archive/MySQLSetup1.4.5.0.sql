...
INSERT INTO be_Posts (PostID, Title, Description, PostContent, DateCreated, DateModified, Author, IsPublished)
	...
	'Welcome to BlogEngine.NET 1.4.5 using MySQL', 
	...
	'<p>If you see this post it means that BlogEngine.NET 1.4.5 is running with MySQL and the DbBlogProvider is configured correctly.</p>
	<h2>Setup</h2>
