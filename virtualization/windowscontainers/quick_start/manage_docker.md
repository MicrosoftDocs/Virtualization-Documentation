...
- Windows Server 2016 TP3 or later configured with the Windows Server Container Feature. If you have completed the setup guides, this is the VM that was created in Azure or Hyper-V.
