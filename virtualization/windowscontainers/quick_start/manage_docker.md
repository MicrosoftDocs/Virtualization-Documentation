...
To create a new image from a specific container use <b>Docker commit <container id> newcontainerimage<b/>. This will create a new container image on the container host.
