...
Be aware that there are some known Docker commands that [don't work](../about/work_in_progress#DockermanagementDockercommandsthatdontworkwithWindowsServerContainers.md) and some that only [partially work](../about/work_in_progress#DockermanagementDockercommandsthatpartiallyworkwithWindowsServerContainers.md)
