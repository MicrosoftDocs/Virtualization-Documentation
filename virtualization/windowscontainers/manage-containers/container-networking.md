...
If you are creating a network, you can specify the name that it is given by the HNS service using the ` com.docker.network.windowsshim.networkname=<network name>` option to the `docker network create` command. 
