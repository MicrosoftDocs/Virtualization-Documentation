...
Managing Hyper-V-isolated containers with Docker is nearly identical to managing process-isolated containers. To create a container with Hyper-V isolation through Docker, use the `--isolation` parameter to set `--isolation=hyperv`.
