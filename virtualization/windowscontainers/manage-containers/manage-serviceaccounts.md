...
# Create the gMSA
New-ADServiceAccount -Name "WebApp01" -DnsHostName "WebApp01.contoso.com" -ServicePrincipalNames "host/WebApp01", "http/WebApp01" -PrincipalsAllowedToRetrieveManagedPassword "WebApp01Hosts"
