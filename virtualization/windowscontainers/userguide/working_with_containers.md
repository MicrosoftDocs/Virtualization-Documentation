...
# For example, this will return all container images whose Name starts with B (case-insensitive):
Get-ContainerImage -Name B*

# You can save the results of this to a variable.
# (If you're not familiar with PowerShell, the "$" denotes a variable.)
$baseImage = Get-ContainerImage -Name Base
$baseImage
