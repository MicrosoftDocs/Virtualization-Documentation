...
- Docker: an automated process that packages and delivers container images. To learn more, see [Docker Engine on Windows](../manage-docker/configure-docker-daemon.md) or visit the [Docker website](https://www.docker.com).
