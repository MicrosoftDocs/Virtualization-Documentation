...
For a complete list of Windows Server Base OS container images, versions, and their respective tags, see this [Windows Base OS container images](https://hub.docker.com/r/microsoft/windows) on Docker Hub.
