...
> Before trying to enable the Hyper-V role make sure your system is compatible. For more information, see [Windows 10 Hyper-V System] Requirements(https://msdn.microsoft.com/virtualization/hyperv_on_windows/quick_start/walkthrough_compatibility).
