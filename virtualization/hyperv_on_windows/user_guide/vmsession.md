...
keywords: windows 10, hyper-v, powershell, integration services, integration components, automation
author: scooley
manager: timlt
ms.date: 05/02/2016
ms.topic: article
