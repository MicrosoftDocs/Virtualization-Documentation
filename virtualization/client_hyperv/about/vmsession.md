...
Note: The virtual machine you want to connect to must be running locally on the host and booted. You can use the following cmdlet to make sure that’s true:
```Get-VM```
