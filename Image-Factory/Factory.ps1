...
if($startfactory) {
    ...
    Start-ImageFactory -FriendlyName "Windows Server 2008 R2 DataCenter with GUI - Gen 2" -ISOFile $2008R2Image -ProductKey $Windows2008R2Key -SKUEdition "ServerDataCenter" -Generation2;
    Start-ImageFactory -FriendlyName "Windows Server 2008 R2 DataCenter Core - Gen 2" -ISOFile $2008R2Image -ProductKey $Windows2008R2Key -SKUEdition "ServerDataCenterCore" -Generation2;
    ...
    Start-ImageFactory -FriendlyName "Windows 7 Enterprise - Gen 2" -ISOFile $7x64Image -ProductKey $Windows7Key -SKUEdition "Enterprise" -Generation2 -desktop $true;
